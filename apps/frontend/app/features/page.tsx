 ...
 * same M1/M2 scope note and auth-aware-nav note; identical shape,
 * different destination copy. */
    ...
    <>
      ...
      <Container as="main" className="flex min-h-[50vh] flex-col items-center justify-center gap-md py-3xl text-center">
        ...
        <Text variant="body" className="max-w-lg">
          {signedIn
            ? "A full feature breakdown is coming soon."
            : "A full feature breakdown is coming soon. In the meantime, create an account to see MANSA in action."}
        </Text>
        <Link
