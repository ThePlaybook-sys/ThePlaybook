...
| `volume-2-system-architecture.md` | v4.0 |
| `volume-3-database-architecture.md` | v4.0 |
...
_Last scanned: 2026-08-06, against the repository state on `claude/playbook-phase0-railway-h5ohzr`._
